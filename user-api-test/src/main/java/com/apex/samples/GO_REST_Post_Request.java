 ...
 */
public class GO_REST_Post_Request implements UserConstants {
...
@Test(dataProvider = "dp_PostData")//name	email	gender	status

	public void createEmployee(String name,String email,String gender,String status) throws ClientProtocolException, IOException {
